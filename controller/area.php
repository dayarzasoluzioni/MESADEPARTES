    ...
    switch($_GET["op"]){
        ...
        case "listar":
            ...
            foreach($datos as $row){
                ...
                $sub_array[] = '<button type="button" class="btn btn-warning waves-effect waves-light btn-sm" onClick="editar('.$row["area_id"].')"><i class="bx bx-edit-alt font-size-16 align-middle"></button>';
                $sub_array[] = '<button type="button" class="btn btn-danger waves-effect waves-light btn-sm" onClick="eliminar('.$row["area_id"].')"><i class="bx bx-trash-alt font-size-16 align-middle"></button>';
                $data[] = $sub_array;
        ...
        case "guardaryeditar":
            ...
            /* TODO: Llama al método get_area_nombre de la instancia $area con los datos del formulario */
