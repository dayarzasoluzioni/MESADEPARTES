<?php
    ...
    switch($_GET["op"]){
        ...
        case "cambiarpass":
            ...
            //TODO: Verifica que el ID del usuario y la contraseña estén disponibles en $_POST
            ...
            //TODO: Define el método de cifrado y la clave
            $cipher = 'aes-256-cbc';
            $key = 'MesaDePartesSoluzioni'; //TODO: Asegurarse de que esta sea la clave real

            //TODO: Genera un IV (vector de inicialización) aleatorio
            $iv = openssl_random_pseudo_bytes(openssl_cipher_iv_length($cipher));

            //TODO: Cifra la contraseña
            $cifrado = openssl_encrypt($usu_pass, $cipher, $key, OPENSSL_RAW_DATA, $iv);

            //TODO: Codifica el IV y el texto cifrado en base64 para almacenar
            $textoCifrado = base64_encode($iv . $cifrado);

            //TODO: Actualiza la contraseña en la base de datos
