    ...
    switch($_GET["op"]){
        ...
        case "listardetalle":
            ...
            foreach($datos as $row){
                ...
                $sub_array[] = '<a class="btn btn-soft-primary waves-effect waves-light btn-sm" href="../../assets/document/'.$row["doc_id"].'/'.$row["det_nom"].'" target="_blank" download><i class="bx bx-search-alt font-size-16 align-middle"></a>';
                $data[] = $sub_array;
        ...
        case "respuesta":
            /* TODO: Llama al método registrar_usuario de la instancia $usuario con los datos del formulario */
            $documento->actualizar_respuesta_documento(
                $_POST["doc_id"], 
                $_POST["doc_respuesta"], 
                $_SESSION["usu_id"]
            );                       
