    ...
    switch($_GET["op"]){
        ...
        case "listardetalle":
            ...
            foreach($datos as $row){
                ...
                $sub_array[] = '<button type="button" class="btn btn-soft-primary waves-effect waves-light btn-sm" onClick="documento('.$row["det_id"].')"><i class="bx bx-search-alt font-size-16 align-middle"></button>';
                $data[] = $sub_array;
