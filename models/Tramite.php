<?php
    ...
    class Tramite extends Conectar{
        ...
        public function insert_tramite($tra_nom, $tra_descrip){
            ...
            /* TODO: Establecer el juego de caracteres a UTF-8 utilizando el método de la clase padre */
            parent::set_names();
            /* TODO: Consulta SQL para insertar un nuevo registro en la tabla tm_tramite */
            $sql="INSERT INTO tm_tramite (tra_nom, tra_descrip)
                VALUES (?, ?)";
            /* TODO: Preparar la consulta SQL */
            $sql=$conectar->prepare($sql);
        ...
        public function update_tramite($tra_id, $tra_nom, $tra_descrip){
            ...
            /* TODO: Establecer el juego de caracteres a UTF-8 utilizando el método de la clase padre */
            parent::set_names();
            /* TODO: Consulta SQL para actualizar un registro en la tabla tm_tramite */
        ...
        public function get_tra_nombre($tra_nom){
            ...
            /* TODO: Establecer el juego de caracteres a UTF-8 utilizando el método de la clase padre */
            parent::set_names();
            /* TODO: Consulta SQL para obtener el nombre del tramite en la tabla tm_tramite */
            $sql="SELECT * FROM tm_tramite
                WHERE tra_nom = ?";

            /* $sql = "SELECT * FROM tm_tramite WHERE tra_nom = ? AND est = 1";  // Solo busca registros activos */
        ...
        public function get_tra_x_id($tra_id){
            ...
            /* TODO: Establecer el juego de caracteres a UTF-8 utilizando el método de la clase padre */
            parent::set_names();
            /* TODO: Consulta SQL para obtener un tramite por id en la tabla tm_tramite */
            $sql="SELECT * FROM tm_tramite
                WHERE tra_id = ?";
        ...
        public function eliminar_tramite($tra_id){
            ...
            /* TODO: Establecer el juego de caracteres a UTF-8 utilizando el método de la clase padre */
            parent::set_names();
            /* TODO: Consulta SQL para eliminar un tramite de la tabla tm_tramite */
            $sql="UPDATE tm_tramite
                SET
                    est = 0,
                    fech_elim = NOW()
